...
El objetivo de este proyecto es simular y validar el flujo completo de compra de un producto, asegurando que todos los componentes clave de la tienda online funcionen de manera integrada y correcta.  
